...
import {MAX_ANSWER_CHARACTER_NUMBER, MAX_QUESTION_CHARACTER_NUMBER, MAX_NARRATION_CHARACTER_NUMBER, MAX_NUMBER_POST_PER_PERIOD_VAL, MAX_NUMBER_RESPONSE_PER_PERIOD_VAL, PERIOD_DAYS_FOR_MAX_NUMBER_CHECK_VAL} from '../globals';
